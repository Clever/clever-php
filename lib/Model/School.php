...
class School implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = $this->getHighGradeAllowableValues();
        if (!in_array($this->container['high_grade'], $allowed_values)) {
        ...
        $allowed_values = $this->getLowGradeAllowableValues();
        if (!in_array($this->container['low_grade'], $allowed_values)) {
            $invalid_properties[] = sprintf(
    ...
    /**
     * Sets high_grade
     * @param string $high_grade
     * @return $this
     */
    public function setHighGrade($high_grade)
    {
        $allowed_values = $this->getHighGradeAllowableValues();
        if (!is_null($high_grade) && !in_array($high_grade, $allowed_values)) {
    ...
    /**
     * Sets low_grade
     * @param string $low_grade
     * @return $this
     */
    public function setLowGrade($low_grade)
    {
        $allowed_values = $this->getLowGradeAllowableValues();
        if (!is_null($low_grade) && !in_array($low_grade, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'low_grade', must be one of '%s'",
                    implode("', '", $allowed_values)
