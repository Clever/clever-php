...
class Student implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = $this->getEllStatusAllowableValues();
        if (!in_array($this->container['ell_status'], $allowed_values)) {
        ...
        $allowed_values = $this->getHispanicEthnicityAllowableValues();
        if (!in_array($this->container['hispanic_ethnicity'], $allowed_values)) {
            $invalid_properties[] = sprintf(
        ...
        $allowed_values = $this->getHomeLanguageAllowableValues();
        if (!in_array($this->container['home_language'], $allowed_values)) {
            $invalid_properties[] = sprintf(
        ...
        $allowed_values = $this->getRaceAllowableValues();
        if (!in_array($this->container['race'], $allowed_values)) {
            $invalid_properties[] = sprintf(
    ...
    /**
     * Sets ell_status
     * @param string $ell_status
     * @return $this
     */
    public function setEllStatus($ell_status)
    {
        $allowed_values = $this->getEllStatusAllowableValues();
        if (!is_null($ell_status) && !in_array($ell_status, $allowed_values)) {
     ...
     * @param string $hispanic_ethnicity
     * @return $this
     */
    public function setHispanicEthnicity($hispanic_ethnicity)
    {
        $allowed_values = $this->getHispanicEthnicityAllowableValues();
        if (!is_null($hispanic_ethnicity) && !in_array($hispanic_ethnicity, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'hispanic_ethnicity', must be one of '%s'",
                    implode("', '", $allowed_values)
    ...
    /**
     * Sets home_language
     * @param string $home_language
     * @return $this
     */
    public function setHomeLanguage($home_language)
    {
        $allowed_values = $this->getHomeLanguageAllowableValues();
        if (!is_null($home_language) && !in_array($home_language, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'home_language', must be one of '%s'",
                    implode("', '", $allowed_values)
    ...
    {
        $allowed_values = $this->getRaceAllowableValues();
        if (!is_null($race) && !in_array($race, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'race', must be one of '%s'",
                    implode("', '", $allowed_values)
